...
- Scored > 0 (need processing): **42**
- Score == 0 (skip — idempotent): **12**
...
| llmd-kv-cache-tiering | agents-mcp | DP | 2 | no screenshots |
| llmd-latency-routing | agents-mcp | DP | 2 | no screenshots |
| llmd-lora-routing | agents-mcp | DP | 2 | no screenshots |
...
- **llmd-core** (model-serving, GA, score 4) — content-only fixes now; live tests deferred as observe-only.
- **evalhub** (evaluation, GA, score 4) — content-only fixes now; live tests deferred as observe-only.
- **llmd-priority-flow-control** (model-serving, GA, score 4) — content-only fixes now; live tests deferred as observe-only.
- **kuberay** (distributed-training, GA, score 3) — content-only fixes now; live tests deferred as observe-only.
- **maas-vllm-deployment** (maas, TP, score 3) — content-only fixes now; live tests deferred as observe-only.
...
- **llmd-kv-cache-tiering** (agents-mcp, DP, score 2) — content-only fixes now; live tests deferred as observe-only.
- **llmd-latency-routing** (agents-mcp, DP, score 2) — content-only fixes now; live tests deferred as observe-only.
- **llmd-lora-routing** (agents-mcp, DP, score 2) — content-only fixes now; live tests deferred as observe-only.
...
### model-registry-catalog (model-registry) — score 8
...
### llmd-core (model-serving) — score 4

- Zero screenshots in assets/images/ (0 png/jpg)
- Placeholder tokens in source blocks: 6 (<age>, <hash>)
- Screenshots on disk: 0

### llmd-priority-flow-control (model-serving) — score 4
...
### maas-vllm-deployment (maas) — score 3
...
### llmd-kv-cache-tiering (agents-mcp) — score 2

- Zero screenshots in assets/images/ (0 png/jpg)
- Screenshots on disk: 0

### llmd-latency-routing (agents-mcp) — score 2

- Zero screenshots in assets/images/ (0 png/jpg)
- Screenshots on disk: 0

### llmd-lora-routing (agents-mcp) — score 2
